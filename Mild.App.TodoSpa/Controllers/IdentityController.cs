...
using Mild.App.TodoSpa.Infrastructure;
using Mild.App.TodoSpa.Services;
...
namespace Mild.App.TodoSpa.Controllers
{
    [ApiController]
    [Authorize]
    ...
    public class IdentityController : ControllerBase
    {
        ...
        public IdentityController(ILogger<IdentityController> logger, IUserService userService, IJwtAuthManager jwtAuthManager)
        {
            _logger = logger;
